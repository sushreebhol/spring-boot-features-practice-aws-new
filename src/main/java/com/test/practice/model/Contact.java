...
public class Contact extends BaseEntity{
    ...
    *           It simply not allow only null values. Except that it will allow everything. Ex:- "", " "
      @NotEmpty: Checks if a given field is not null and its size/length is greater than zero.
      *          It simply not allow null value and empty string without spaces like "" .Except that it will allow everything.
      *          Ex:- " "
      @NotBlank: Checks if a given field is not null and trimmed length is greater than zero.
      *          It simply not allow anything like null, "", " " . It only allows string with at least one value inside like "Hi"
    * */
    @NotBlank(message="Name must not be blank")
    @Size(min=3, message="Name must be at least 3 characters@pass long")
    private String name;
